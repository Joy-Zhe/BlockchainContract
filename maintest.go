...
func (s *SmartContract) QueryALLContract_incompany(ctx contractapi.TransactionContextInterface) ([]QueryResult, error) {
	startKey := ""
	endKey := ""
	...
	for resultsIterator.HasNext() {
		...
		queryResult := QueryResult{Key: queryResponse.Key, Record: contract}
